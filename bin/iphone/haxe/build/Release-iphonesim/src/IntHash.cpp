...
{
{
	HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/IntHash.hx",30)
...
Void IntHash_obj::set( int key,Dynamic value){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/IntHash.hx",34)
...
Dynamic IntHash_obj::get( int key){
	...
	HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/IntHash.hx",38)
...
bool IntHash_obj::exists( int key){
	...
	HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/IntHash.hx",42)
...
bool IntHash_obj::remove( int key){
	...
	HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/IntHash.hx",46)
	...
	for(::cpp::FastIterator_obj< int > *__it = ::cpp::CreateFastIterator< int >(it);  __it->hasNext(); ){
		int i = __it->next();
		{
			...
			if ((it->__Field(HX_CSTRING("hasNext"))())){
				HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/IntHash.hx",69)
				hx::IndexRef((s->b).mPtr,s->b->__Field(HX_CSTRING("length"))) = HX_CSTRING(", ");
			}
		}
;
