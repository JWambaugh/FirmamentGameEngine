...
int TriangleCulling_obj::__FindIndex(::String inName)
{
	...
	if (inName==HX_CSTRING("POSITIVE")) return 2;
...
{
Static(NEGATIVE) = hx::CreateEnum< TriangleCulling_obj >(HX_CSTRING("NEGATIVE"),0);
Static(NONE) = hx::CreateEnum< TriangleCulling_obj >(HX_CSTRING("NONE"),1);
Static(POSITIVE) = hx::CreateEnum< TriangleCulling_obj >(HX_CSTRING("POSITIVE"),2);
}
