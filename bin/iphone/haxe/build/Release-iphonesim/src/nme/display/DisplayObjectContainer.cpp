...
{
{
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObjectContainer.hx",24)
	super::__construct(inHandle,inType);
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObjectContainer.hx",25)
...
::nme::display::DisplayObject DisplayObjectContainer_obj::addChild( ::nme::display::DisplayObject child){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObjectContainer.hx",31)
	if (((child == hx::ObjectPtr<OBJ_>(this)))){
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObjectContainer.hx",32)
		hx::Throw (HX_CSTRING("Adding to self"));
	}
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObjectContainer.hx",36)
	if (((child->nmeParent == hx::ObjectPtr<OBJ_>(this)))){
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObjectContainer.hx",37)
		this->setChildIndex(child,(this->nmeChildren->length - (int)1));
	}
	else{
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObjectContainer.hx",42)
		child->nmeSetParent(hx::ObjectPtr<OBJ_>(this));
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObjectContainer.hx",43)
		this->nmeChildren->push(child);
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObjectContainer.hx",44)
		::nme::display::DisplayObjectContainer_obj::nme_doc_add_child(this->nmeHandle,child->nmeHandle);
	}
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObjectContainer.hx",47)
	return child;
}
...
::nme::display::DisplayObject DisplayObjectContainer_obj::addChildAt( ::nme::display::DisplayObject child,int index){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObjectContainer.hx",53)
	this->addChild(child);
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObjectContainer.hx",54)
	this->setChildIndex(child,index);
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObjectContainer.hx",56)
	return child;
}
...
bool DisplayObjectContainer_obj::areInaccessibleObjectsUnderPoint( ::nme::geom::Point point){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObjectContainer.hx",61)
	return false;
}
...
bool DisplayObjectContainer_obj::contains( ::nme::display::DisplayObject child){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObjectContainer.hx",68)
	if (((child == null()))){
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObjectContainer.hx",69)
		return false;
	}
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObjectContainer.hx",71)
	if (((hx::ObjectPtr<OBJ_>(this) == child))){
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObjectContainer.hx",72)
		return true;
	}
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObjectContainer.hx",74)
	{
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObjectContainer.hx",74)
		int _g = (int)0;
		...
		while(((_g < _g1->length))){
			...
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObjectContainer.hx",74)
			++(_g);
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObjectContainer.hx",75)
			if (((c == child))){
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObjectContainer.hx",76)
				return true;
			}
		}
	}
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObjectContainer.hx",78)
	return false;
}
...
::nme::display::DisplayObject DisplayObjectContainer_obj::getChildAt( int index){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObjectContainer.hx",84)
	if (((bool((index >= (int)0)) && bool((index < this->nmeChildren->length))))){
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObjectContainer.hx",85)
		return this->nmeChildren->__get(index);
	}
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObjectContainer.hx",88)
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObjectContainer.hx",90)
	return null();
}
...
::nme::display::DisplayObject DisplayObjectContainer_obj::getChildByName( ::String name){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObjectContainer.hx",96)
	{
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObjectContainer.hx",96)
		int _g = (int)0;
		Array< ::nme::display::DisplayObject > _g1 = this->nmeChildren;
		...
		while(((_g < _g1->length))){
			...
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObjectContainer.hx",96)
			++(_g);
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObjectContainer.hx",97)
			if (((name == c->nmeGetName()))){
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObjectContainer.hx",98)
				return c;
			}
		}
	}
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObjectContainer.hx",99)
	return null();
}
...
int DisplayObjectContainer_obj::getChildIndex( ::nme::display::DisplayObject child){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObjectContainer.hx",105)
	{
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObjectContainer.hx",105)
		int _g1 = (int)0;
		...
		while(((_g1 < _g))){
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObjectContainer.hx",105)
			int i = (_g1)++;
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObjectContainer.hx",106)
			if (((this->nmeChildren->__get(i) == child))){
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObjectContainer.hx",107)
				return i;
			}
		}
	}
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObjectContainer.hx",108)
	return (int)-1;
}
...
Array< ::nme::display::DisplayObject > DisplayObjectContainer_obj::getObjectsUnderPoint( ::nme::geom::Point point){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObjectContainer.hx",114)
	Array< ::nme::display::DisplayObject > result = Array_obj< ::nme::display::DisplayObject >::__new();
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObjectContainer.hx",115)
	this->nmeGetObjectsUnderPoint(point,result);
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObjectContainer.hx",116)
	return result;
}
...
Void DisplayObjectContainer_obj::nmeBroadcast( ::nme::events::Event inEvt){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObjectContainer.hx",122)
		int i = (int)0;
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObjectContainer.hx",124)
		if (((this->nmeChildren->length > (int)0))){
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObjectContainer.hx",125)
			while((true)){
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObjectContainer.hx",127)
				::nme::display::DisplayObject child = this->nmeChildren->__get(i);
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObjectContainer.hx",128)
				child->nmeBroadcast(inEvt);
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObjectContainer.hx",130)
				if (((i >= this->nmeChildren->length))){
					HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObjectContainer.hx",131)
					break;
				}
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObjectContainer.hx",133)
				if (((this->nmeChildren->__get(i) == child))){
					HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObjectContainer.hx",135)
					(i)++;
					HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObjectContainer.hx",136)
					if (((i >= this->nmeChildren->length))){
						HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObjectContainer.hx",137)
						break;
					}
				}
			}
		}
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObjectContainer.hx",141)
...
::nme::display::DisplayObject DisplayObjectContainer_obj::nmeFindByID( int inID){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObjectContainer.hx",147)
	if (((this->nmeID == inID))){
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObjectContainer.hx",148)
		return hx::ObjectPtr<OBJ_>(this);
	}
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObjectContainer.hx",150)
	{
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObjectContainer.hx",150)
		int _g = (int)0;
		Array< ::nme::display::DisplayObject > _g1 = this->nmeChildren;
		...
		while(((_g < _g1->length))){
			...
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObjectContainer.hx",150)
			++(_g);
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObjectContainer.hx",152)
			::nme::display::DisplayObject found = child->nmeFindByID(inID);
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObjectContainer.hx",154)
			if (((found != null()))){
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObjectContainer.hx",155)
				return found;
			}
		}
	}
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObjectContainer.hx",158)
...
Void DisplayObjectContainer_obj::nmeGetObjectsUnderPoint( ::nme::geom::Point point,Array< ::nme::display::DisplayObject > result){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObjectContainer.hx",164)
		this->super::nmeGetObjectsUnderPoint(point,result);
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObjectContainer.hx",166)
		{
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObjectContainer.hx",166)
			int _g = (int)0;
			Array< ::nme::display::DisplayObject > _g1 = this->nmeChildren;
			...
			while(((_g < _g1->length))){
				...
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObjectContainer.hx",166)
				++(_g);
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObjectContainer.hx",167)
				this->nmeGetObjectsUnderPoint(point,result);
			}
		}
	}
...
Void DisplayObjectContainer_obj::nmeOnAdded( ::nme::display::DisplayObject inObj,bool inIsOnStage){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObjectContainer.hx",173)
		this->super::nmeOnAdded(inObj,inIsOnStage);
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObjectContainer.hx",175)
		{
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObjectContainer.hx",175)
			int _g = (int)0;
			Array< ::nme::display::DisplayObject > _g1 = this->nmeChildren;
			...
			while(((_g < _g1->length))){
				...
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObjectContainer.hx",175)
				++(_g);
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObjectContainer.hx",176)
...
Void DisplayObjectContainer_obj::nmeOnRemoved( ::nme::display::DisplayObject inObj,bool inWasOnStage){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObjectContainer.hx",182)
		this->super::nmeOnRemoved(inObj,inWasOnStage);
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObjectContainer.hx",184)
		{
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObjectContainer.hx",184)
			int _g = (int)0;
			Array< ::nme::display::DisplayObject > _g1 = this->nmeChildren;
			...
			while(((_g < _g1->length))){
				...
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObjectContainer.hx",184)
				++(_g);
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObjectContainer.hx",185)
...
Void DisplayObjectContainer_obj::nmeRemoveChildFromArray( ::nme::display::DisplayObject child){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObjectContainer.hx",194)
		int i = this->getChildIndex(child);
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObjectContainer.hx",196)
		if (((i >= (int)0))){
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObjectContainer.hx",198)
			::nme::display::DisplayObjectContainer_obj::nme_doc_remove_child(this->nmeHandle,i);
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObjectContainer.hx",199)
...
::nme::display::DisplayObject DisplayObjectContainer_obj::removeChild( ::nme::display::DisplayObject child){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObjectContainer.hx",206)
	int c = this->getChildIndex(child);
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObjectContainer.hx",208)
	if (((c >= (int)0))){
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObjectContainer.hx",210)
		child->nmeSetParent(null());
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObjectContainer.hx",211)
		return child;
	}
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObjectContainer.hx",214)
	return null();
}
...
::nme::display::DisplayObject DisplayObjectContainer_obj::removeChildAt( int index){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObjectContainer.hx",220)
	if (((bool((index >= (int)0)) && bool((index < this->nmeChildren->length))))){
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObjectContainer.hx",222)
		::nme::display::DisplayObject result = this->nmeChildren->__get(index);
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObjectContainer.hx",223)
		result->nmeSetParent(null());
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObjectContainer.hx",224)
		return result;
	}
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObjectContainer.hx",227)
	return null();
}
...
Void DisplayObjectContainer_obj::setChildIndex( ::nme::display::DisplayObject child,int index){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObjectContainer.hx",233)
		if (((index > this->nmeChildren->length))){
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObjectContainer.hx",234)
			hx::Throw ((HX_CSTRING("Invalid index position ") + index));
		}
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObjectContainer.hx",236)
		::nme::display::DisplayObject s = null();
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObjectContainer.hx",237)
		int orig = this->getChildIndex(child);
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObjectContainer.hx",239)
		if (((orig < (int)0))){
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObjectContainer.hx",241)
			::String msg = ((HX_CSTRING("setChildIndex : object ") + child->toString()) + HX_CSTRING(" not found."));
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObjectContainer.hx",243)
			if (((child->nmeParent == hx::ObjectPtr<OBJ_>(this)))){
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObjectContainer.hx",245)
				int realindex = (int)-1;
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObjectContainer.hx",247)
				{
					HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObjectContainer.hx",247)
					int _g1 = (int)0;
					int _g = this->nmeChildren->length;
					...
					while(((_g1 < _g))){
						HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObjectContainer.hx",247)
						int i = (_g1)++;
						HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObjectContainer.hx",249)
						if (((this->nmeChildren->__get(i) == child))){
							HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObjectContainer.hx",251)
							realindex = i;
							HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObjectContainer.hx",252)
							break;
						}
					}
				}
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObjectContainer.hx",256)
				if (((realindex != (int)-1))){
					HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObjectContainer.hx",257)
					hx::AddEq(msg,(HX_CSTRING("Internal error: Real child index was ") + ::Std_obj::string(realindex)));
				}
				else{
					HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObjectContainer.hx",259)
					hx::AddEq(msg,HX_CSTRING("Internal error: Child was not in nmeChildren array!"));
				}
			}
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObjectContainer.hx",262)
			hx::Throw (msg);
		}
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObjectContainer.hx",265)
		::nme::display::DisplayObjectContainer_obj::nme_doc_set_child_index(this->nmeHandle,child->nmeHandle,index);
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObjectContainer.hx",267)
		if (((index < orig))){
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObjectContainer.hx",269)
			int i = orig;
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObjectContainer.hx",271)
			while(((i > index))){
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObjectContainer.hx",273)
				this->nmeChildren[i] = this->nmeChildren->__get((i - (int)1));
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObjectContainer.hx",274)
				(i)--;
			}
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObjectContainer.hx",277)
			this->nmeChildren[index] = child;
		}
		else{
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObjectContainer.hx",280)
			if (((orig < index))){
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObjectContainer.hx",282)
				int i = orig;
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObjectContainer.hx",283)
				while(((i < index))){
					HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObjectContainer.hx",285)
					this->nmeChildren[i] = this->nmeChildren->__get((i + (int)1));
					HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObjectContainer.hx",286)
					(i)++;
				}
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObjectContainer.hx",289)
				this->nmeChildren[index] = child;
			}
		}
	}
...
Void DisplayObjectContainer_obj::swapChildren( ::nme::display::DisplayObject child1,::nme::display::DisplayObject child2){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObjectContainer.hx",296)
		int idx1 = this->getChildIndex(child1);
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObjectContainer.hx",297)
		int idx2 = this->getChildIndex(child2);
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObjectContainer.hx",298)
		if (((bool((idx1 < (int)0)) || bool((idx2 < (int)0))))){
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObjectContainer.hx",299)
			hx::Throw (HX_CSTRING("swapChildren:Could not find children"));
		}
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObjectContainer.hx",300)
...
Void DisplayObjectContainer_obj::swapChildrenAt( int index1,int index2){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObjectContainer.hx",306)
		if (((bool((bool((bool((index1 < (int)0)) || bool((index2 < (int)0)))) || bool((index1 > this->nmeChildren->length)))) || bool((index2 > this->nmeChildren->length))))){
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObjectContainer.hx",307)
			hx::Throw (::nme::errors::RangeError_obj::__new(HX_CSTRING("swapChildrenAt : index out of bounds")));
		}
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObjectContainer.hx",309)
		if (((index1 == index2))){
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObjectContainer.hx",310)
			return null();
		}
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObjectContainer.hx",312)
		::nme::display::DisplayObject tmp = this->nmeChildren->__get(index1);
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObjectContainer.hx",313)
		this->nmeChildren[index1] = this->nmeChildren->__get(index2);
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObjectContainer.hx",314)
		this->nmeChildren[index2] = tmp;
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObjectContainer.hx",315)
...
bool DisplayObjectContainer_obj::nmeGetMouseChildren( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObjectContainer.hx",324)
...
bool DisplayObjectContainer_obj::nmeSetMouseChildren( bool inVal){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObjectContainer.hx",327)
	::nme::display::DisplayObjectContainer_obj::nme_doc_set_mouse_children(this->nmeHandle,inVal);
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObjectContainer.hx",328)
	return inVal;
}
...
int DisplayObjectContainer_obj::nmeGetNumChildren( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObjectContainer.hx",332)
...
bool DisplayObjectContainer_obj::nmeGetTabChildren( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObjectContainer.hx",333)
	return false;
}
...
bool DisplayObjectContainer_obj::nmeSetTabChildren( bool inValue){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObjectContainer.hx",334)
	return false;
}
