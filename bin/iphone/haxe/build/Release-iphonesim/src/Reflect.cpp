...
bool Reflect_obj::hasField( Dynamic o,::String field){
	...
	HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/Reflect.hx",29)
...
Dynamic Reflect_obj::field( Dynamic o,::String field){
	...
	HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/Reflect.hx",33)
...
Void Reflect_obj::setField( Dynamic o,::String field,Dynamic value){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/Reflect.hx",37)
		if (((o != null()))){
...
Dynamic Reflect_obj::callMethod( Dynamic o,Dynamic func,Dynamic args){
	...
	if (((bool((func != null())) && bool((func->__GetType() == ::vtString))))){
		HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/Reflect.hx",44)
		func = o->__Field(func);
	}
...
bool Reflect_obj::isFunction( Dynamic f){
	...
	HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/Reflect.hx",56)
...
int Reflect_obj::compare( Dynamic a,Dynamic b){
	...
	HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/Reflect.hx",60)
...
Dynamic Reflect_obj::copy( Dynamic o){
	...
	if (((o->__GetType() == ::vtArray))){
		HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/Reflect.hx",88)
...
Dynamic Reflect_obj::makeVarArgs( Dynamic f){
	...
	HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/Reflect.hx",95)
