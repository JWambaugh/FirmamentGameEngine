...
{
{
	HX_SOURCE_POS("/usr/lib/haxe/std/cpp/io/FileOutput.hx",35)
	this->__f = f;
}
;
	return null();
...
Void FileOutput_obj::writeByte( int c){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/std/cpp/io/FileOutput.hx",39)
		try{
...
int FileOutput_obj::writeBytes( ::haxe::io::Bytes s,int p,int l){
	...
	HX_SOURCE_POS("/usr/lib/haxe/std/cpp/io/FileOutput.hx",43)
...
Void FileOutput_obj::flush( ){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/std/cpp/io/FileOutput.hx",47)
...
::cpp::io::FileSeek _switch_1 = (pos);
		...
		HX_SOURCE_POS("/usr/lib/haxe/std/cpp/io/FileOutput.hx",56)
...
int FileOutput_obj::tell( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/std/cpp/io/FileOutput.hx",60)
