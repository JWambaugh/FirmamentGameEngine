...
Void Output_obj::writeByte( int c){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/Output.hx",37)
...
int Output_obj::writeBytes( ::haxe::io::Bytes s,int pos,int len){
	...
	if (((bool((bool((pos < (int)0)) || bool((len < (int)0)))) || bool(((pos + len) > s->length))))){
		HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/Output.hx",46)
...
Void Output_obj::writeFullBytes( ::haxe::io::Bytes s,int pos,int len){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/Output.hx",88)
		while(((len > (int)0))){
...
Void Output_obj::writeFloat( double x){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/Output.hx",96)
...
Void Output_obj::writeDouble( double x){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/Output.hx",108)
...
Void Output_obj::writeInt8( int x){
{
		...
		if (((bool((x < (int)-128)) || bool((x >= (int)128))))){
			HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/Output.hx",122)
...
Void Output_obj::writeInt32( ::cpp::CppInt32__ x){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/Output.hx",192)
		if ((this->bigEndian)){
...
Void Output_obj::writeInput( ::haxe::io::Input i,Dynamic bufsize){
{
		...
		if (((bufsize == null()))){
			HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/Output.hx",217)
			bufsize = (int)4096;
		}
		...
		try{
			...
			while((true)){
				...
				if (((len == (int)0))){
					HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/Output.hx",223)
					hx::Throw (::haxe::io::Error_obj::Blocked_dyn());
				}
				...
				while(((len > (int)0))){
					...
					if (((k == (int)0))){
						HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/Output.hx",228)
						hx::Throw (::haxe::io::Error_obj::Blocked_dyn());
					}
