...
int Input_obj::readBytes( ::haxe::io::Bytes s,int pos,int len){
	...
	if (((bool((bool((pos < (int)0)) || bool((len < (int)0)))) || bool(((pos + len) > s->length))))){
		HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/Input.hx",48)
...
::haxe::io::Bytes Input_obj::readAll( Dynamic bufsize){
	...
	if (((bufsize == null()))){
		HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/Input.hx",80)
		bufsize = (int)16384;
	}
	...
	try{
		...
		while((true)){
			...
			if (((len == (int)0))){
				HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/Input.hx",88)
...
Void Input_obj::readFullBytes( ::haxe::io::Bytes s,int pos,int len){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/Input.hx",96)
		while(((len > (int)0))){
	...
	try{
		...
		if (__e.IsClass< ::haxe::io::Eof >() ){
			::haxe::io::Eof e = __e;{
				...
				if (((s.length == (int)0))){
					HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/Input.hx",136)
					hx::Throw (e);
				}
			}
		}
...
double Input_obj::readFloat( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/Input.hx",141)
...
double Input_obj::readDouble( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/Input.hx",155)
...
int Input_obj::readInt8( ){
	...
	if (((n >= (int)128))){
		HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/Input.hx",172)
		return (n - (int)256);
	}
...
int Input_obj::readInt16( ){
	...
	if (((((int(n) & int((int)32768))) != (int)0))){
		HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/Input.hx",181)
		return (n - (int)65536);
	}
...
int Input_obj::readInt24( ){
	...
	if (((((int(n) & int((int)8388608))) != (int)0))){
		HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/Input.hx",197)
...
::cpp::CppInt32__ Input_obj::readInt32( ){
	...
	int ch4 = this->readByte();
	HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/Input.hx",245)
...
::String Input_obj::readString( int len){
	...
	HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/Input.hx",250)
	::haxe::io::Bytes b = ::haxe::io::Bytes_obj::alloc(len);
	HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/Input.hx",251)
	this->readFullBytes(b,(int)0,len);
	HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/Input.hx",255)
	return b->toString();
}
