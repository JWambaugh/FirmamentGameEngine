...
{
{
	HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/Date.hx",31)
...
double Date_obj::getTime( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/Date.hx",35)
...
::Date Date_obj::now( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/Date.hx",55)
...
::Date Date_obj::fromString( ::String s){
	...
	switch( (int)(s.length)){
		...
		;break;
		default: {
			HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/Date.hx",80)
