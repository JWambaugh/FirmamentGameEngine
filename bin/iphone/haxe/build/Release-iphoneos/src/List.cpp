...
{
{
	HX_SOURCE_POS("/usr/lib/haxe/std/List.hx",44)
	this->length = (int)0;
}
;
	return null();
...
Void List_obj::push( Dynamic item){
{
		...
		if (((this->q == null()))){
			HX_SOURCE_POS("/usr/lib/haxe/std/List.hx",72)
			this->q = x;
		}
...
Dynamic List_obj::first( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/std/List.hx",80)
...
Dynamic List_obj::last( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/std/List.hx",88)
...
Dynamic List_obj::pop( ){
	...
	if (((this->h == null()))){
		HX_SOURCE_POS("/usr/lib/haxe/std/List.hx",100)
		return null();
	}
	...
	if (((this->h == null()))){
		HX_SOURCE_POS("/usr/lib/haxe/std/List.hx",104)
		this->q = null();
	}
...
bool List_obj::isEmpty( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/std/List.hx",112)
	return (this->h == null());
}
...
bool List_obj::remove( Dynamic v){
	...
	while(((l != null()))){
		...
		if (((l->__GetItem((int)0) == v))){
			...
			if (((this->q == l))){
				HX_SOURCE_POS("/usr/lib/haxe/std/List.hx",139)
				this->q = prev;
			}
...
Dynamic List_obj::iterator( ){
	...
	struct _Function_1_1{
		inline static Dynamic Block( ::List_obj *__this){
			...
			Dynamic run(){
{
					HX_SOURCE_POS("/usr/lib/haxe/std/List.hx",155)
			...
			Dynamic run(){
{
					...
					if (((__this->__Field(HX_CSTRING("h")) == null()))){
						HX_SOURCE_POS("/usr/lib/haxe/std/List.hx",161)
						return null();
					}
	...
	HX_SOURCE_POS("/usr/lib/haxe/std/List.hx",152)
...
::List List_obj::filter( Dynamic f){
	...
	while(((l != null()))){
		...
		if ((f(v).Cast< bool >())){
			HX_SOURCE_POS("/usr/lib/haxe/std/List.hx",219)
			l2->add(v);
		}
	}
