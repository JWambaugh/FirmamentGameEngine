...
::Class Type_obj::getSuperClass( ::Class c){
	...
	HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/Type.hx",56)
	return c->GetSuper();
}
...
::String Type_obj::getClassName( ::Class c){
	...
	if (((c == null()))){
		HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/Type.hx",62)
		return null();
	}
...
::String Type_obj::getEnumName( ::Enum e){
	...
	HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/Type.hx",66)
	return e->__ToString();
}
...
::Class Type_obj::resolveClass( ::String name){
	...
	if (((bool((result != null())) && bool(result->__IsEnum())))){
		HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/Type.hx",73)
		return null();
	}
...
::Enum Type_obj::resolveEnum( ::String name){
	...
	if (((bool((result != null())) && bool(!(result->__IsEnum()))))){
		HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/Type.hx",80)
		return null();
	}
...
Dynamic Type_obj::createInstance( ::Class cl,Dynamic args){
	...
	if (((cl != null()))){
		HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/Type.hx",86)
...
Dynamic Type_obj::createEmptyInstance( ::Class cl){
	...
	HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/Type.hx",90)
...
Dynamic Type_obj::createEnum( ::Enum e,::String constr,Dynamic params){
	...
	if (((e->mConstructEnum != null()))){
		HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/Type.hx",96)
...
Array< ::String > Type_obj::getInstanceFields( ::Class c){
	...
	HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/Type.hx",106)
...
Array< ::String > Type_obj::getClassFields( ::Class c){
	...
	HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/Type.hx",110)
...
Array< ::String > Type_obj::getEnumConstructs( ::Enum e){
	...
	HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/Type.hx",114)
...
::ValueType Type_obj::_typeof( Dynamic v){
	...
	if (  ( _switch_2==::vtBool)){
		...
		HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/Type.hx",129)
...
bool Type_obj::enumEq( Dynamic a,Dynamic b){
	...
	HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/Type.hx",134)
	return (a == b);
}
...
::String Type_obj::enumConstructor( Dynamic e){
	...
	HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/Type.hx",138)
	return e->__Tag();
}
...
int Type_obj::enumIndex( Dynamic e){
	...
	HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/Type.hx",147)
	return e->__Index();
}
