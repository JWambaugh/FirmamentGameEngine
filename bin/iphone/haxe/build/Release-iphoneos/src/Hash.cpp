...
{
{
	...
	HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/Hash.hx",29)
...
Void Hash_obj::set( ::String key,Dynamic value){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/Hash.hx",33)
...
Dynamic Hash_obj::get( ::String key){
	...
	HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/Hash.hx",37)
...
bool Hash_obj::exists( ::String key){
	...
	HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/Hash.hx",41)
...
bool Hash_obj::remove( ::String key){
	...
	HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/Hash.hx",45)
			...
			bool run(){
{
			...
			Dynamic run(){
{
					HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/Hash.hx",68)
...
::String Hash_obj::toString( ){
	...
	for(::cpp::FastIterator_obj< ::String > *__it = ::cpp::CreateFastIterator< ::String >(it);  __it->hasNext(); ){
		::String i = __it->next();
		{
			...
			HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/Hash.hx",84)
			if ((it->__Field(HX_CSTRING("hasNext"))())){
				HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/Hash.hx",85)
				hx::IndexRef((s->b).mPtr,s->b->__Field(HX_CSTRING("length"))) = HX_CSTRING(", ");
			}
		}
;
	...
	hx::IndexRef((s->b).mPtr,s->b->__Field(HX_CSTRING("length"))) = HX_CSTRING("}");
	HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/Hash.hx",88)
