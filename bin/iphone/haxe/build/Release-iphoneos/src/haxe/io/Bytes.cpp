...
int Bytes_obj::get( int pos){
	...
	HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/Bytes.hx",37)
...
Void Bytes_obj::set( int pos,int v){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/Bytes.hx",51)
		this->b[pos] = v;
	}
return null();
}
	...
	HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/Bytes.hx",137)
	{
		...
		while(((_g < len))){
			...
			if (((b1->__get(i) != b2->__get(i)))){
				HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/Bytes.hx",140)
...
::String Bytes_obj::toString( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/Bytes.hx",192)
...
::String Bytes_obj::toHex( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/Bytes.hx",209)
	Array< Dynamic > chars = Array_obj< Dynamic >::__new();
	HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/Bytes.hx",210)
	::String str = HX_CSTRING("0123456789abcdef");
	HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/Bytes.hx",211)
	{
		HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/Bytes.hx",211)
		int _g1 = (int)0;
		int _g = str.length;
		...
		while(((_g1 < _g))){
			HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/Bytes.hx",211)
			int i = (_g1)++;
			HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/Bytes.hx",212)
			chars->push(str.charCodeAt(i));
		}
	}
	HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/Bytes.hx",213)
	{
		HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/Bytes.hx",213)
		int _g1 = (int)0;
		int _g = this->length;
		...
		while(((_g1 < _g))){
			HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/Bytes.hx",213)
			int i = (_g1)++;
			HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/Bytes.hx",214)
			int c = this->b->__get(i);
			HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/Bytes.hx",215)
			{
				HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/Bytes.hx",215)
			...
			HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/Bytes.hx",216)
			{
				HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/Bytes.hx",216)
	...
	HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/Bytes.hx",218)
...
Array< unsigned char > Bytes_obj::getData( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/Bytes.hx",221)
	return this->b;
}
...
::haxe::io::Bytes Bytes_obj::alloc( int length){
	...
	HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/Bytes.hx",242)
	Array< unsigned char > a = Array_obj< unsigned char >::__new();
	HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/Bytes.hx",243)
	if (((length > (int)0))){
		HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/Bytes.hx",243)
		a[(length - (int)1)] = (int)0;
	}
	HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/Bytes.hx",244)
...
::haxe::io::Bytes Bytes_obj::ofString( ::String s){
	...
	HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/Bytes.hx",264)
	Array< unsigned char > a = Array_obj< unsigned char >::__new();
	HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/Bytes.hx",265)
	::__hxcpp_bytes_of_string(a,s);
	HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/Bytes.hx",266)
...
::haxe::io::Bytes Bytes_obj::ofData( Array< unsigned char > b){
	...
	HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/Bytes.hx",292)
