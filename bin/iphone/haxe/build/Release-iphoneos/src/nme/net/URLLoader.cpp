...
{
{
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/net/URLLoader.hx",56)
	super::__construct(null());
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/net/URLLoader.hx",57)
	this->nmeHandle = (int)0;
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/net/URLLoader.hx",58)
	this->bytesLoaded = (int)0;
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/net/URLLoader.hx",59)
	this->bytesTotal = (int)-1;
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/net/URLLoader.hx",60)
	this->state = (int)0;
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/net/URLLoader.hx",61)
	this->dataFormat = ::nme::net::URLLoaderDataFormat_obj::TEXT_dyn();
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/net/URLLoader.hx",62)
	if (((request != null()))){
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/net/URLLoader.hx",63)
		this->load(request);
	}
}
;
...
Array< ::String > URLLoader_obj::getCookies( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/net/URLLoader.hx",74)
...
Void URLLoader_obj::load( ::nme::net::URLRequest request){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/net/URLLoader.hx",93)
		this->state = (int)1;
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/net/URLLoader.hx",94)
		::String pref = request->url.substr((int)0,(int)7);
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/net/URLLoader.hx",95)
		if (((bool((pref != HX_CSTRING("http://"))) && bool((pref != HX_CSTRING("https:/")))))){
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/net/URLLoader.hx",97)
			try{
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/net/URLLoader.hx",98)
				::nme::utils::ByteArray bytes = ::nme::utils::ByteArray_obj::readFile(request->url);
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/net/URLLoader.hx",99)
				{
::nme::net::URLLoaderDataFormat _switch_1 = (this->dataFormat);
					switch((_switch_1)->GetIndex()){
						case 1: {
							HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/net/URLLoader.hx",101)
							this->data = bytes->asString();
						}
						;break;
						case 2: {
							HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/net/URLLoader.hx",103)
							this->data = ::nme::net::URLVariables_obj::__new(bytes->asString());
						}
						;break;
						default: {
							HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/net/URLLoader.hx",105)
							this->data = bytes;
						}
					}
				}
				...
				{
					Dynamic e = __e;{
						HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/net/URLLoader.hx",111)
						this->onError(e);
						HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/net/URLLoader.hx",112)
						return null();
					}
				}
			}
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/net/URLLoader.hx",115)
			this->nmeDataComplete();
		}
		else{
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/net/URLLoader.hx",119)
			request->nmePrepare();
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/net/URLLoader.hx",120)
			this->nmeHandle = ::nme::net::URLLoader_obj::nme_curl_create(request);
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/net/URLLoader.hx",121)
			if (((this->nmeHandle == null()))){
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/net/URLLoader.hx",122)
				this->onError(HX_CSTRING("Could not open URL"));
			}
			else{
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/net/URLLoader.hx",126)
...
Void URLLoader_obj::nmeDataComplete( ){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/net/URLLoader.hx",131)
		if (((this->nmeOnComplete_dyn() != null()))){
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/net/URLLoader.hx",133)
			if ((this->nmeOnComplete(this->data))){
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/net/URLLoader.hx",135)
				this->dispatchEvent(::nme::events::Event_obj::__new(::nme::events::Event_obj::COMPLETE,null(),null()));
			}
			else{
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/net/URLLoader.hx",137)
				this->DispatchIOErrorEvent();
			}
		}
		else{
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/net/URLLoader.hx",140)
			this->dispatchEvent(::nme::events::Event_obj::__new(::nme::events::Event_obj::COMPLETE,null(),null()));
		}
	}
return null();
...
Void URLLoader_obj::onError( ::String msg){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/net/URLLoader.hx",177)
...
Void URLLoader_obj::update( ){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/net/URLLoader.hx",183)
		if (((this->nmeHandle != null()))){
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/net/URLLoader.hx",186)
			int old_state = this->state;
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/net/URLLoader.hx",187)
			int old_loaded = this->bytesLoaded;
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/net/URLLoader.hx",188)
			int old_total = this->bytesTotal;
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/net/URLLoader.hx",189)
			::nme::net::URLLoader_obj::nme_curl_update_loader(this->nmeHandle,hx::ObjectPtr<OBJ_>(this));
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/net/URLLoader.hx",190)
			if (((bool((old_total < (int)0)) && bool((this->bytesTotal > (int)0))))){
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/net/URLLoader.hx",191)
				this->dispatchEvent(::nme::events::Event_obj::__new(::nme::events::Event_obj::OPEN,null(),null()));
			}
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/net/URLLoader.hx",195)
			if (((bool((this->bytesTotal > (int)0)) && bool((this->bytesLoaded != old_loaded))))){
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/net/URLLoader.hx",196)
				this->dispatchEvent(::nme::events::ProgressEvent_obj::__new(HX_CSTRING("progress"),false,false,this->bytesLoaded,this->bytesTotal));
			}
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/net/URLLoader.hx",200)
			int code = ::nme::net::URLLoader_obj::nme_curl_get_code(this->nmeHandle);
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/net/URLLoader.hx",201)
			if (((this->state == (int)3))){
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/net/URLLoader.hx",202)
				if (((code < (int)400))){
					HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/net/URLLoader.hx",205)
					::nme::utils::ByteArray bytes = ::nme::net::URLLoader_obj::nme_curl_get_data(this->nmeHandle);
					HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/net/URLLoader.hx",206)
					{
::nme::net::URLLoaderDataFormat _switch_2 = (this->dataFormat);
						switch((_switch_2)->GetIndex()){
							case 1: case 2: {
								HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/net/URLLoader.hx",208)
								this->data = (  (((bytes == null()))) ? ::String(HX_CSTRING("")) : ::String(bytes->asString()) );
							}
							;break;
							default: {
								HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/net/URLLoader.hx",210)
								this->data = bytes;
							}
						}
					}
					HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/net/URLLoader.hx",213)
					this->nmeDataComplete();
				}
				else{
					HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/net/URLLoader.hx",218)
					...
					HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/net/URLLoader.hx",219)
					this->nmeHandle = null();
					HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/net/URLLoader.hx",220)
					this->dispatchEvent(evt);
				}
			}
			else{
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/net/URLLoader.hx",223)
				if (((this->state == (int)4))){
					HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/net/URLLoader.hx",225)
					...
					HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/net/URLLoader.hx",226)
					this->nmeHandle = null();
					HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/net/URLLoader.hx",227)
					this->dispatchEvent(evt);
				}
			}
		}
...
bool URLLoader_obj::hasActive( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/net/URLLoader.hx",80)
...
Void URLLoader_obj::initialize( ::String inCACertFilePath){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/net/URLLoader.hx",86)
...
bool URLLoader_obj::nmeLoadPending( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/net/URLLoader.hx",151)
	return !(::nme::net::URLLoader_obj::activeLoaders->isEmpty());
}
...
Void URLLoader_obj::nmePollData( ){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/net/URLLoader.hx",160)
		if ((!(::nme::net::URLLoader_obj::activeLoaders->isEmpty()))){
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/net/URLLoader.hx",163)
			::nme::net::URLLoader_obj::nme_curl_process_loaders();
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/net/URLLoader.hx",164)
			::List oldLoaders = ::nme::net::URLLoader_obj::activeLoaders;
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/net/URLLoader.hx",165)
			::nme::net::URLLoader_obj::activeLoaders = ::List_obj::__new();
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/net/URLLoader.hx",166)
			for(::cpp::FastIterator_obj< ::nme::net::URLLoader > *__it = ::cpp::CreateFastIterator< ::nme::net::URLLoader >(oldLoaders->iterator());  __it->hasNext(); ){
				...
				{
					HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/net/URLLoader.hx",168)
					loader->update();
					HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/net/URLLoader.hx",169)
					if (((loader->state == (int)2))){
						HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/net/URLLoader.hx",170)
