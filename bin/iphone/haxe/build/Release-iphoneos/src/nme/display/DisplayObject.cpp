...
{
{
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObject.hx",173)
	super::__construct(hx::ObjectPtr<OBJ_>(this));
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObject.hx",175)
	this->nmeParent = null();
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObject.hx",176)
	this->nmeHandle = inHandle;
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObject.hx",177)
	this->nmeID = ::nme::display::DisplayObject_obj::nme_display_object_get_id(this->nmeHandle);
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObject.hx",178)
...
::nme::geom::Point DisplayObject_obj::globalToLocal( ::nme::geom::Point inGlobal){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObject.hx",189)
	::nme::geom::Point result = inGlobal->clone();
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObject.hx",190)
	::nme::display::DisplayObject_obj::nme_display_object_global_to_local(this->nmeHandle,result);
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObject.hx",191)
	return result;
}
...
{
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObject.hx",207)
...
::nme::geom::Point DisplayObject_obj::localToGlobal( ::nme::geom::Point inLocal){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObject.hx",219)
	::nme::geom::Point result = inLocal->clone();
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObject.hx",220)
	::nme::display::DisplayObject_obj::nme_display_object_local_to_global(this->nmeHandle,result);
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObject.hx",221)
	return result;
}
...
::nme::display::InteractiveObject DisplayObject_obj::nmeAsInteractiveObject( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObject.hx",226)
	return null();
}
...
Void DisplayObject_obj::nmeBroadcast( ::nme::events::Event inEvt){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObject.hx",235)
...
Void DisplayObject_obj::nmeDrawToSurface( Dynamic inSurface,::nme::geom::Matrix matrix,::nme::geom::ColorTransform colorTransform,::String blendMode,::nme::geom::Rectangle clipRect,bool smoothing){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObject.hx",244)
...
::nme::display::DisplayObject DisplayObject_obj::nmeFindByID( int inID){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObject.hx",252)
	if (((this->nmeID == inID))){
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObject.hx",253)
		return hx::ObjectPtr<OBJ_>(this);
	}
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObject.hx",254)
	return null();
}
...
Void DisplayObject_obj::nmeFireEvent( ::nme::events::Event inEvt){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObject.hx",260)
		Array< ::nme::display::InteractiveObject > stack = Array_obj< ::nme::display::InteractiveObject >::__new();
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObject.hx",262)
		if (((this->nmeParent != null()))){
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObject.hx",263)
			this->nmeParent->nmeGetInteractiveObjectStack(stack);
		}
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObject.hx",265)
		int l = stack->length;
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObject.hx",267)
		if (((l > (int)0))){
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObject.hx",270)
			inEvt->nmeSetPhase(::nme::events::EventPhase_obj::CAPTURING_PHASE);
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObject.hx",271)
			stack->reverse();
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObject.hx",273)
			{
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObject.hx",273)
				int _g = (int)0;
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObject.hx",273)
				while(((_g < stack->length))){
					...
					HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObject.hx",273)
					++(_g);
					HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObject.hx",275)
					inEvt->nmeSetCurrentTarget(obj);
					HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObject.hx",276)
					obj->dispatchEvent(inEvt);
					HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObject.hx",278)
					if ((inEvt->nmeGetIsCancelled())){
						HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObject.hx",279)
						return null();
					}
				}
			}
		}
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObject.hx",285)
		inEvt->nmeSetPhase(::nme::events::EventPhase_obj::AT_TARGET);
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObject.hx",286)
		inEvt->nmeSetCurrentTarget(hx::ObjectPtr<OBJ_>(this));
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObject.hx",287)
		this->dispatchEvent(inEvt);
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObject.hx",289)
		if ((inEvt->nmeGetIsCancelled())){
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObject.hx",290)
			return null();
		}
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObject.hx",293)
		if ((inEvt->nmeGetBubbles())){
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObject.hx",295)
			inEvt->nmeSetPhase(::nme::events::EventPhase_obj::BUBBLING_PHASE);
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObject.hx",296)
			stack->reverse();
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObject.hx",298)
			{
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObject.hx",298)
				int _g = (int)0;
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObject.hx",298)
				while(((_g < stack->length))){
					...
					HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObject.hx",298)
					++(_g);
					HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObject.hx",300)
					inEvt->nmeSetCurrentTarget(obj);
					HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObject.hx",301)
					obj->dispatchEvent(inEvt);
					HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObject.hx",303)
					if ((inEvt->nmeGetIsCancelled())){
						HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObject.hx",304)
						return null();
					}
				}
			}
...
::nme::geom::ColorTransform DisplayObject_obj::nmeGetColorTransform( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObject.hx",315)
	::nme::geom::ColorTransform trans = ::nme::geom::ColorTransform_obj::__new(null(),null(),null(),null(),null(),null(),null(),null());
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObject.hx",316)
	::nme::display::DisplayObject_obj::nme_display_object_get_color_transform(this->nmeHandle,trans,false);
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObject.hx",317)
	return trans;
}
...
::nme::geom::ColorTransform DisplayObject_obj::nmeGetConcatenatedColorTransform( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObject.hx",326)
	::nme::geom::ColorTransform trans = ::nme::geom::ColorTransform_obj::__new(null(),null(),null(),null(),null(),null(),null(),null());
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObject.hx",327)
	::nme::display::DisplayObject_obj::nme_display_object_get_color_transform(this->nmeHandle,trans,true);
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObject.hx",328)
	return trans;
}
...
::nme::geom::Matrix DisplayObject_obj::nmeGetConcatenatedMatrix( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObject.hx",337)
	::nme::geom::Matrix mtx = ::nme::geom::Matrix_obj::__new(null(),null(),null(),null(),null(),null());
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObject.hx",338)
	::nme::display::DisplayObject_obj::nme_display_object_get_matrix(this->nmeHandle,mtx,true);
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObject.hx",339)
	return mtx;
}
...
Void DisplayObject_obj::nmeGetInteractiveObjectStack( Array< ::nme::display::InteractiveObject > outStack){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObject.hx",348)
		::nme::display::InteractiveObject io = this->nmeAsInteractiveObject();
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObject.hx",350)
		if (((io != null()))){
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObject.hx",351)
			outStack->push(io);
		}
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObject.hx",353)
		if (((this->nmeParent != null()))){
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObject.hx",354)
...
::nme::geom::Matrix DisplayObject_obj::nmeGetMatrix( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObject.hx",363)
	::nme::geom::Matrix mtx = ::nme::geom::Matrix_obj::__new(null(),null(),null(),null(),null(),null());
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObject.hx",364)
	::nme::display::DisplayObject_obj::nme_display_object_get_matrix(this->nmeHandle,mtx,false);
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObject.hx",365)
	return mtx;
}
...
Void DisplayObject_obj::nmeGetObjectsUnderPoint( ::nme::geom::Point point,Array< ::nme::display::DisplayObject > result){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObject.hx",373)
		if ((::nme::display::DisplayObject_obj::nme_display_object_hit_test_point(this->nmeHandle,point->x,point->y,true,false))){
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObject.hx",375)
...
::nme::geom::Rectangle DisplayObject_obj::nmeGetPixelBounds( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObject.hx",384)
	::nme::geom::Rectangle rect = ::nme::geom::Rectangle_obj::__new(null(),null(),null(),null());
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObject.hx",385)
	::nme::display::DisplayObject_obj::nme_display_object_get_pixel_bounds(this->nmeHandle,rect);
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObject.hx",386)
	return rect;
}
...
Void DisplayObject_obj::nmeOnAdded( ::nme::display::DisplayObject inObj,bool inIsOnStage){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObject.hx",392)
		if (((inObj == hx::ObjectPtr<OBJ_>(this)))){
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObject.hx",394)
			::nme::events::Event evt = ::nme::events::Event_obj::__new(::nme::events::Event_obj::ADDED,true,false);
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObject.hx",395)
			evt->nmeSetTarget(inObj);
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObject.hx",396)
			this->dispatchEvent(evt);
		}
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObject.hx",399)
		if ((inIsOnStage)){
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObject.hx",401)
			::nme::events::Event evt = ::nme::events::Event_obj::__new(::nme::events::Event_obj::ADDED_TO_STAGE,false,false);
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObject.hx",402)
			evt->nmeSetTarget(inObj);
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObject.hx",403)
			this->dispatchEvent(evt);
		}
	}
return null();
...
Void DisplayObject_obj::nmeOnRemoved( ::nme::display::DisplayObject inObj,bool inWasOnStage){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObject.hx",410)
		if (((inObj == hx::ObjectPtr<OBJ_>(this)))){
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObject.hx",412)
			::nme::events::Event evt = ::nme::events::Event_obj::__new(::nme::events::Event_obj::REMOVED,true,false);
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObject.hx",413)
			evt->nmeSetTarget(inObj);
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObject.hx",414)
			this->dispatchEvent(evt);
		}
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObject.hx",417)
		if ((inWasOnStage)){
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObject.hx",419)
			::nme::events::Event evt = ::nme::events::Event_obj::__new(::nme::events::Event_obj::REMOVED_FROM_STAGE,false,false);
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObject.hx",420)
			evt->nmeSetTarget(inObj);
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObject.hx",421)
			this->dispatchEvent(evt);
		}
	}
return null();
...
Void DisplayObject_obj::nmeSetColorTransform( ::nme::geom::ColorTransform inTrans){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObject.hx",430)
...
Void DisplayObject_obj::nmeSetMatrix( ::nme::geom::Matrix inMatrix){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObject.hx",439)
...
::String DisplayObject_obj::toString( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObject.hx",448)
...
double DisplayObject_obj::nmeGetAlpha( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObject.hx",458)
...
double DisplayObject_obj::nmeSetAlpha( double inAlpha){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObject.hx",461)
	::nme::display::DisplayObject_obj::nme_display_object_set_alpha(this->nmeHandle,inAlpha);
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObject.hx",462)
	return inAlpha;
}
...
Dynamic DisplayObject_obj::nmeGetBG( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObject.hx",468)
	int i = ::nme::display::DisplayObject_obj::nme_display_object_get_bg(this->nmeHandle);
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObject.hx",469)
	if (((((int(i) & int((int)16777216))) == (int)0))){
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObject.hx",470)
		return null();
	}
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObject.hx",472)
...
Dynamic DisplayObject_obj::nmeSetBG( Dynamic inBG){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObject.hx",478)
	if (((inBG == null()))){
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObject.hx",479)
		::nme::display::DisplayObject_obj::nme_display_object_set_bg(this->nmeHandle,(int)0);
	}
	else{
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObject.hx",481)
		::nme::display::DisplayObject_obj::nme_display_object_set_bg(this->nmeHandle,inBG);
	}
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObject.hx",483)
	return inBG;
}
...
::nme::display::BlendMode DisplayObject_obj::nmeGetBlendMode( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObject.hx",489)
	int i = ::nme::display::DisplayObject_obj::nme_display_object_get_blend_mode(this->nmeHandle);
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObject.hx",490)
...
::nme::display::BlendMode DisplayObject_obj::nmeSetBlendMode( ::nme::display::BlendMode inMode){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObject.hx",496)
	::nme::display::DisplayObject_obj::nme_display_object_set_blend_mode(this->nmeHandle,inMode->__Index());
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObject.hx",497)
	return inMode;
}
...
bool DisplayObject_obj::nmeGetCacheAsBitmap( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObject.hx",501)
...
bool DisplayObject_obj::nmeSetCacheAsBitmap( bool inVal){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObject.hx",504)
	::nme::display::DisplayObject_obj::nme_display_object_set_cache_as_bitmap(this->nmeHandle,inVal);
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObject.hx",505)
	return inVal;
}
...
Dynamic DisplayObject_obj::nmeGetFilters( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObject.hx",511)
	if (((this->nmeFilters == null()))){
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObject.hx",511)
		return Dynamic( Array_obj<Dynamic>::__new());
	}
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObject.hx",513)
	Dynamic result = Dynamic( Array_obj<Dynamic>::__new() );
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObject.hx",515)
	{
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObject.hx",515)
		int _g = (int)0;
		...
		while(((_g < _g1->__Field(HX_CSTRING("length"))))){
			...
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObject.hx",515)
			++(_g);
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObject.hx",516)
			result->__Field(HX_CSTRING("push"))(filter->__Field(HX_CSTRING("clone"))());
		}
	}
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObject.hx",518)
	return result;
}
...
Dynamic DisplayObject_obj::nmeSetFilters( Dynamic inFilters){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObject.hx",524)
	if (((inFilters == null()))){
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObject.hx",525)
		this->nmeFilters = null();
	}
	else{
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObject.hx",530)
		this->nmeFilters = Dynamic( Array_obj<Dynamic>::__new() );
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObject.hx",532)
		{
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObject.hx",532)
			int _g = (int)0;
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObject.hx",532)
			while(((_g < inFilters->__Field(HX_CSTRING("length"))))){
				...
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObject.hx",532)
				++(_g);
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObject.hx",533)
				this->nmeFilters->__Field(HX_CSTRING("push"))(filter->__Field(HX_CSTRING("clone"))());
			}
		}
	}
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObject.hx",536)
	::nme::display::DisplayObject_obj::nme_display_object_set_filters(this->nmeHandle,this->nmeFilters);
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObject.hx",538)
	return inFilters;
}
...
::nme::display::Graphics DisplayObject_obj::nmeGetGraphics( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObject.hx",547)
	if (((this->nmeGraphicsCache == null()))){
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObject.hx",548)
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObject.hx",549)
...
double DisplayObject_obj::nmeGetHeight( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObject.hx",553)
...
double DisplayObject_obj::nmeSetHeight( double inVal){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObject.hx",556)
	::nme::display::DisplayObject_obj::nme_display_object_set_height(this->nmeHandle,inVal);
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObject.hx",557)
	return inVal;
}
...
::nme::display::DisplayObject DisplayObject_obj::nmeSetMask( ::nme::display::DisplayObject inObject){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObject.hx",563)
	this->mask = inObject;
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObject.hx",564)
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObject.hx",565)
	return inObject;
}
...
double DisplayObject_obj::nmeGetMouseX( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObject.hx",569)
...
double DisplayObject_obj::nmeGetMouseY( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObject.hx",570)
...
::String DisplayObject_obj::nmeGetName( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObject.hx",573)
...
::String DisplayObject_obj::nmeSetName( ::String inVal){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObject.hx",576)
	::nme::display::DisplayObject_obj::nme_display_object_set_name(this->nmeHandle,inVal);
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObject.hx",577)
	return inVal;
}
...
::nme::display::DisplayObjectContainer DisplayObject_obj::nmeGetParent( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObject.hx",581)
...
::nme::display::DisplayObjectContainer DisplayObject_obj::nmeSetParent( ::nme::display::DisplayObjectContainer inParent){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObject.hx",588)
	if (((inParent == this->nmeParent))){
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObject.hx",589)
		return inParent;
	}
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObject.hx",591)
	if (((this->nmeParent != null()))){
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObject.hx",592)
		this->nmeParent->nmeRemoveChildFromArray(hx::ObjectPtr<OBJ_>(this));
	}
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObject.hx",594)
	if (((bool((this->nmeParent == null())) && bool((inParent != null()))))){
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObject.hx",596)
		this->nmeParent = inParent;
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObject.hx",597)
		this->nmeOnAdded(hx::ObjectPtr<OBJ_>(this),(this->nmeGetStage() != null()));
	}
	else{
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObject.hx",599)
		if (((bool((this->nmeParent != null())) && bool((inParent == null()))))){
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObject.hx",601)
			bool was_on_stage = (this->nmeGetStage() != null());
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObject.hx",602)
			this->nmeParent = inParent;
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObject.hx",603)
			this->nmeOnRemoved(hx::ObjectPtr<OBJ_>(this),was_on_stage);
		}
		else{
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObject.hx",606)
			this->nmeParent = inParent;
		}
	}
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObject.hx",610)
	return inParent;
}
...
double DisplayObject_obj::nmeGetRotation( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObject.hx",614)
...
double DisplayObject_obj::nmeSetRotation( double inVal){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObject.hx",617)
	::nme::display::DisplayObject_obj::nme_display_object_set_rotation(this->nmeHandle,inVal);
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObject.hx",618)
	return inVal;
}
...
::nme::geom::Rectangle DisplayObject_obj::nmeGetScale9Grid( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObject.hx",622)
...
::nme::geom::Rectangle DisplayObject_obj::nmeSetScale9Grid( ::nme::geom::Rectangle inRect){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObject.hx",625)
	this->nmeScale9Grid = (  (((inRect == null()))) ? ::nme::geom::Rectangle(null()) : ::nme::geom::Rectangle(inRect->clone()) );
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObject.hx",626)
	::nme::display::DisplayObject_obj::nme_display_object_set_scale9_grid(this->nmeHandle,this->nmeScale9Grid);
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObject.hx",627)
	return inRect;
}
...
double DisplayObject_obj::nmeGetScaleX( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObject.hx",631)
...
double DisplayObject_obj::nmeSetScaleX( double inVal){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObject.hx",634)
	::nme::display::DisplayObject_obj::nme_display_object_set_scale_x(this->nmeHandle,inVal);
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObject.hx",635)
	return inVal;
}
...
double DisplayObject_obj::nmeGetScaleY( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObject.hx",639)
...
double DisplayObject_obj::nmeSetScaleY( double inVal){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObject.hx",642)
	::nme::display::DisplayObject_obj::nme_display_object_set_scale_y(this->nmeHandle,inVal);
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObject.hx",643)
	return inVal;
}
...
::nme::geom::Rectangle DisplayObject_obj::nmeGetScrollRect( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObject.hx",647)
...
::nme::geom::Rectangle DisplayObject_obj::nmeSetScrollRect( ::nme::geom::Rectangle inRect){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObject.hx",650)
	this->nmeScrollRect = (  (((inRect == null()))) ? ::nme::geom::Rectangle(null()) : ::nme::geom::Rectangle(inRect->clone()) );
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObject.hx",651)
	::nme::display::DisplayObject_obj::nme_display_object_set_scroll_rect(this->nmeHandle,this->nmeScrollRect);
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObject.hx",652)
	return inRect;
}
...
::nme::display::Stage DisplayObject_obj::nmeGetStage( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObject.hx",661)
	if (((this->nmeParent != null()))){
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObject.hx",662)
		return this->nmeParent->nmeGetStage();
	}
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObject.hx",664)
	return null();
}
...
::nme::geom::Transform DisplayObject_obj::nmeGetTransform( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObject.hx",668)
...
::nme::geom::Transform DisplayObject_obj::nmeSetTransform( ::nme::geom::Transform inTransform){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObject.hx",671)
	this->nmeSetMatrix(inTransform->nmeGetMatrix());
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObject.hx",672)
	this->nmeSetColorTransform(inTransform->nmeGetColorTransform());
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObject.hx",673)
	return inTransform;
}
...
bool DisplayObject_obj::nmeGetVisible( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObject.hx",677)
...
bool DisplayObject_obj::nmeSetVisible( bool inVal){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObject.hx",680)
	::nme::display::DisplayObject_obj::nme_display_object_set_visible(this->nmeHandle,inVal);
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObject.hx",681)
	return inVal;
}
...
double DisplayObject_obj::nmeGetWidth( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObject.hx",685)
...
double DisplayObject_obj::nmeSetWidth( double inVal){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObject.hx",688)
	::nme::display::DisplayObject_obj::nme_display_object_set_width(this->nmeHandle,inVal);
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObject.hx",689)
	return inVal;
}
...
double DisplayObject_obj::nmeGetX( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObject.hx",693)
...
double DisplayObject_obj::nmeSetX( double inVal){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObject.hx",696)
	::nme::display::DisplayObject_obj::nme_display_object_set_x(this->nmeHandle,inVal);
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObject.hx",697)
	return inVal;
}
...
double DisplayObject_obj::nmeGetY( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObject.hx",701)
...
double DisplayObject_obj::nmeSetY( double inVal){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObject.hx",704)
	::nme::display::DisplayObject_obj::nme_display_object_set_y(this->nmeHandle,inVal);
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/DisplayObject.hx",705)
	return inVal;
}
