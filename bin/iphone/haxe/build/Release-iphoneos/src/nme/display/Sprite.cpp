...
{
{
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/Sprite.hx",18)
...
::String Sprite_obj::nmeGetType( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/Sprite.hx",24)
...
{
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/Sprite.hx",30)
		if (((this->nmeGetStage() != null()))){
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/Sprite.hx",32)
...
Void Sprite_obj::stopDrag( ){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/Sprite.hx",37)
		if (((this->nmeGetStage() != null()))){
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/Sprite.hx",39)
