...
{
{
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/Graphics.hx",23)
...
Void Graphics_obj::arcTo( double inCX,double inCY,double inX,double inY){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/Graphics.hx",29)
...
{
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/Graphics.hx",35)
...
{
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/Graphics.hx",41)
...
{
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/Graphics.hx",48)
		if (((matrix == null()))){
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/Graphics.hx",50)
			matrix = ::nme::geom::Matrix_obj::__new(null(),null(),null(),null(),null(),null());
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/Graphics.hx",51)
			matrix->createGradientBox((int)200,(int)200,(int)0,(int)-100,(int)-100);
		}
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/Graphics.hx",54)
...
Void Graphics_obj::clear( ){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/Graphics.hx",59)
...
Void Graphics_obj::curveTo( double inCX,double inCY,double inX,double inY){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/Graphics.hx",65)
...
Void Graphics_obj::drawCircle( double inX,double inY,double inRadius){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/Graphics.hx",71)
...
Void Graphics_obj::drawEllipse( double inX,double inY,double inWidth,double inHeight){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/Graphics.hx",77)
...
Void Graphics_obj::drawGraphicsData( Array< ::nme::display::IGraphicsData > graphicsData){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/Graphics.hx",84)
		Dynamic handles = Dynamic( Array_obj<Dynamic>::__new() );
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/Graphics.hx",86)
		{
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/Graphics.hx",86)
			int _g = (int)0;
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/Graphics.hx",86)
			while(((_g < graphicsData->length))){
				...
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/Graphics.hx",86)
				++(_g);
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/Graphics.hx",87)
				handles->__Field(HX_CSTRING("push"))(datum->nmeHandle);
			}
		}
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/Graphics.hx",89)
...
Void Graphics_obj::drawGraphicsDatum( ::nme::display::IGraphicsData graphicsDatum){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/Graphics.hx",94)
...
{
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/Graphics.hx",100)
...
Void Graphics_obj::drawRect( double inX,double inY,double inWidth,double inHeight){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/Graphics.hx",106)
...
Void Graphics_obj::drawRoundRect( double inX,double inY,double inWidth,double inHeight,double inRadX,Dynamic inRadY){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/Graphics.hx",112)
...
{
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/Graphics.hx",122)
		this->beginBitmapFill(sheet->nmeBitmap,null(),false,inSmooth);
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/Graphics.hx",124)
		if ((inSmooth)){
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/Graphics.hx",125)
			hx::OrEq(inFlags,(int)4096);
		}
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/Graphics.hx",127)
...
{
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/Graphics.hx",133)
		int cull = (  (((culling == null()))) ? int((int)0) : int((culling->__Index() - (int)1)) );
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/Graphics.hx",134)
...
Void Graphics_obj::endFill( ){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/Graphics.hx",139)
...
{
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/Graphics.hx",145)
...
{
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/Graphics.hx",152)
		if (((matrix == null()))){
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/Graphics.hx",154)
			matrix = ::nme::geom::Matrix_obj::__new(null(),null(),null(),null(),null(),null());
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/Graphics.hx",155)
			matrix->createGradientBox((int)200,(int)200,(int)0,(int)-100,(int)-100);
		}
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/Graphics.hx",158)
...
{
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/Graphics.hx",163)
...
Void Graphics_obj::lineTo( double inX,double inY){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/Graphics.hx",169)
...
Void Graphics_obj::moveTo( double inX,double inY){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/Graphics.hx",175)
...
{
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,2,0/nme/display/Graphics.hx",181)
