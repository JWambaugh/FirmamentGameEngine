...
bool FileSystem_obj::exists( ::String path){
	...
	HX_SOURCE_POS("/usr/lib/haxe/std/cpp/FileSystem.hx",49)
...
Void FileSystem_obj::rename( ::String path,::String newpath){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/std/cpp/FileSystem.hx",53)
		if (((::cpp::FileSystem_obj::sys_rename(path,newpath) == null()))){
			HX_SOURCE_POS("/usr/lib/haxe/std/cpp/FileSystem.hx",55)
...
Dynamic FileSystem_obj::stat( ::String path){
	...
	if (((s == null()))){
		...
		HX_SOURCE_POS("/usr/lib/haxe/std/cpp/FileSystem.hx",61)
...
::String FileSystem_obj::fullPath( ::String relpath){
	...
	HX_SOURCE_POS("/usr/lib/haxe/std/cpp/FileSystem.hx",68)
...
bool FileSystem_obj::isDirectory( ::String path){
	...
	HX_SOURCE_POS("/usr/lib/haxe/std/cpp/FileSystem.hx",81)
...
Void FileSystem_obj::createDirectory( ::String path){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/std/cpp/FileSystem.hx",85)
		if (((::cpp::FileSystem_obj::sys_create_dir(path,(int)493) == null()))){
			HX_SOURCE_POS("/usr/lib/haxe/std/cpp/FileSystem.hx",87)
...
Void FileSystem_obj::deleteFile( ::String path){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/std/cpp/FileSystem.hx",90)
		if (((::cpp::FileSystem_obj::file_delete(path) == null()))){
			HX_SOURCE_POS("/usr/lib/haxe/std/cpp/FileSystem.hx",92)
...
Void FileSystem_obj::deleteDirectory( ::String path){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/std/cpp/FileSystem.hx",95)
		if (((::cpp::FileSystem_obj::sys_remove_dir(path) == null()))){
			HX_SOURCE_POS("/usr/lib/haxe/std/cpp/FileSystem.hx",97)
...
Array< ::String > FileSystem_obj::readDirectory( ::String path){
	...
	HX_SOURCE_POS("/usr/lib/haxe/std/cpp/FileSystem.hx",100)
