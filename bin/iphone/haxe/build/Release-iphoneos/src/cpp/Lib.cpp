...
Dynamic Lib_obj::load( ::String lib,::String prim,int nargs){
	...
	HX_SOURCE_POS("/usr/lib/haxe/std/cpp/Lib.hx",32)
...
Dynamic Lib_obj::loadLazy( ::String lib,::String prim,int nargs){
	...
	HX_SOURCE_POS("/usr/lib/haxe/std/cpp/Lib.hx",44)
	try{
...
Void Lib_obj::print( Dynamic v){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/std/cpp/Lib.hx",66)
		::__hxcpp_print(v);
	}
return null();
}
...
Dynamic Lib_obj::haxeToNeko( Dynamic v){
	...
	HX_SOURCE_POS("/usr/lib/haxe/std/cpp/Lib.hx",74)
	return v;
}
...
Dynamic Lib_obj::nekoToHaxe( Dynamic v){
	...
	HX_SOURCE_POS("/usr/lib/haxe/std/cpp/Lib.hx",82)
	return v;
}
...
Void Lib_obj::println( Dynamic v){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/std/cpp/Lib.hx",88)
		::__hxcpp_println(v);
	}
return null();
}
