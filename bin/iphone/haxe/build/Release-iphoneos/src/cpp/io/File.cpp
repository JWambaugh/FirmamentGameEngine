...
::cpp::io::FileInput File_obj::read( ::String path,bool binary){
	...
	HX_SOURCE_POS("/usr/lib/haxe/std/cpp/io/File.hx",50)
...
::cpp::io::FileOutput File_obj::write( ::String path,bool binary){
	...
	HX_SOURCE_POS("/usr/lib/haxe/std/cpp/io/File.hx",54)
...
::cpp::io::FileOutput File_obj::append( ::String path,bool binary){
	...
	HX_SOURCE_POS("/usr/lib/haxe/std/cpp/io/File.hx",58)
...
::cpp::io::FileInput File_obj::_stdin( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/std/cpp/io/File.hx",70)
...
::cpp::io::FileOutput File_obj::_stdout( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/std/cpp/io/File.hx",74)
...
::cpp::io::FileOutput File_obj::_stderr( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/std/cpp/io/File.hx",78)
...
int File_obj::getChar( bool echo){
	...
	HX_SOURCE_POS("/usr/lib/haxe/std/cpp/io/File.hx",82)
