...
{
{
	HX_SOURCE_POS("/usr/lib/haxe/std/cpp/io/FileInput.hx",35)
	this->__f = f;
}
;
	return null();
...
int FileInput_obj::readByte( ){
	...
	struct _Function_1_1{
		inline static int Block( ::cpp::io::FileInput_obj *__this){
			...
			try{
				...
				{
					Dynamic e = __e;{
						HX_SOURCE_POS("/usr/lib/haxe/std/cpp/io/FileInput.hx",42)
	...
	HX_SOURCE_POS("/usr/lib/haxe/std/cpp/io/FileInput.hx",39)
...
int FileInput_obj::readBytes( ::haxe::io::Bytes s,int p,int l){
	...
	struct _Function_1_1{
		inline static int Block( ::cpp::io::FileInput_obj *__this,::haxe::io::Bytes &s,int &p,int &l){
			...
			try{
				...
				{
					Dynamic e = __e;{
						HX_SOURCE_POS("/usr/lib/haxe/std/cpp/io/FileInput.hx",53)
						return (  ((e->__IsArray())) ? int(hx::Throw (::haxe::io::Eof_obj::__new())) : int(hx::Throw (::haxe::io::Error_obj::Custom(e))) );
					}
				}
			}
	...
	HX_SOURCE_POS("/usr/lib/haxe/std/cpp/io/FileInput.hx",50)
...
::cpp::io::FileSeek _switch_1 = (pos);
		...
		HX_SOURCE_POS("/usr/lib/haxe/std/cpp/io/FileInput.hx",66)
...
int FileInput_obj::tell( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/std/cpp/io/FileInput.hx",70)
...
bool FileInput_obj::eof( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/std/cpp/io/FileInput.hx",75)
