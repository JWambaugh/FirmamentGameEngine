...
class FThreadPool
{
        ...
        private var threads:Array<FPoolThread>;
    #end
    ...
    public function new(numThreads:Int) 
    {
        tasks = new Array <Task> ();
            ...
            threads = new Array<FPoolThread>();
            for (i in 0...this.numThreads)
            {
                threads.push(new FPoolThread());
            }
        #end
    }
    ...
    public function addTask(task:Dynamic->Dynamic, arg:Dynamic, onFinish:Dynamic->Void):Void
    {
        ...
        private function getNextFreeThread():FPoolThread
        {
    ...
    public function blockRunAllTasks():Void
    {
            ...
            {
                // get a free thread
                var thread:FPoolThread = getNextFreeThread();
